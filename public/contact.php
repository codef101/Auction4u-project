...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Contact Us For Any Queries</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    <div id="success"></div>
                    <form name="sentMessage" method="POST" id="contactForm" action="contacthandler.php" novalidate="novalidate" class="">
                        ...
                        <div class="">
                            <button class="btn btn-primary py-2 px-4" type="submit" name="submit" id="sendMessageButton">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-5 mb-5">
                ...
                <p>Feel free to leave a feedback or ask any queries. Our team will try our best to provide you the superior browsing experience and 
                    solve the problem for you.
                </p>
                <div class="d-flex flex-column mb-3">
                    <h5 class="font-weight-semi-bold mb-3">Our Headquaters</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Lorong Ria 4, Taman Bunga Raya, Setapak, Kuala Lumpur</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>auction4u@gmail.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+60-176388500</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="detail1.html"><i class="fa fa-angle-right mr-2"></i>Instagram</a>
                            <a class="text-dark mb-2" href="cart.html"><i class="fa fa-angle-right mr-2"></i>LinkedIn</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
